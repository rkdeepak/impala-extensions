...
public class EventServiceTest extends TestCase {
    ...
    private Event[] Event() {
        EventType lowPriority = new EventType("mytype", false, true, false, new Period().withMillis(10));
        EventType highPriority = new EventType("mytype", false, true, false, Period.ZERO);
        EventType anotherType = new EventType("anothertype", false, true, false, new Period().withMillis(20));
        EventType irrelevantType = new EventType("irrelevanttype", false, true, false, new Period().withMillis(20));
