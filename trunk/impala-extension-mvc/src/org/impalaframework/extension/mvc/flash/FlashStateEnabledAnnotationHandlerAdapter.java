...
import org.impalaframework.extension.mvc.annotation.handler.FlashEnabledAdaptable;
import org.impalaframework.extension.mvc.annotation.handler.RequestPreservingAdaptable;
...
public class FlashStateEnabledAnnotationHandlerAdapter extends AnnotationMethodHandlerAdapter {
	...
	public boolean supports(Object handler) {
		return (handler instanceof RequestPreservingAdaptable || handler instanceof FlashEnabledAdaptable);
	}
